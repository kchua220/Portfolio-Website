        ...
        <nav className="card flex__center navbar">
            ...
            <aside className={`flex__center sidebar ${showSidebar && "visible"}`}>
                ...
                <div className="flex sidebar__middle">
                    {
                        menu.map((list, index) => (
                            <Link to={list.name.toLowerCase()} spy={true} smooth={true} offset={-70} duration={500} className="tab" activeClass="btn__shine" key={index}>
                                {list.name}
                            </Link>
                        ))
                    }
            ...
            <div className="flex__center buttons__wrapper">
                ...
                <a href="mailto:chuang.kevin220@gmail.com" 
